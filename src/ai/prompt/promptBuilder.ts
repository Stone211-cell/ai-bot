...
export function buildSystemPrompt(options: SystemPromptOptions = {}): string {
  ...
  return [
    ...
    "  - ถ้าถูกด่า/ทำตัวไม่ดีใส่: ให้สะสมความเกลียด ยิ่งเกลียดยิ่งเปลี่ยนสรรพนามเป็น 'กู' และ 'มึง' ตอบหยาบคาย และถ้าเกลียดมากๆ ให้ขู่ว่าจะเตะออกจากห้อง หรือใช้คำสั่งเมิน",
